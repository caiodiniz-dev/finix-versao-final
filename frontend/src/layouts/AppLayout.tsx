      ...
      <div className="px-5 py-6 border-b border-border">
        <div className="flex items-center gap-4">
          <Logo
            ...
            altText={
              user.plan === "PRO" ? user.companyName || "Logo" : undefined
            }
        ...
        <div className="flex gap-2 items-center">
          {alertCount > 0 && (
            ...
            >
              ...
              <span className="absolute -top-2 -right-2 inline-flex h-5 min-w-[1.25rem] items-center justify-center rounded-full bg-rose-500 px-1.5 text-[10px] font-bold text-white">
                {alertCount}
              </span>
            </button>
          )}
