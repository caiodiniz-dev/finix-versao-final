      ...
      <div className="hidden lg:flex bg-auth-side relative overflow-hidden items-center justify-center p-12">
        ...
        >
          ...
          <p className="mt-4 text-white/80">
            Organize gastos, economize mais e alcance seus objetivos com o
            Finix.
          </p>
          <div className="mt-10 grid grid-cols-2 gap-4">
            {[
              ...
              <div
                key={k.label}
                className="rounded-2xl bg-surface/10 border border-white/15 backdrop-blur p-4"
              >
      ...
      <div className="flex items-center justify-center p-6 sm:p-12 bg-surface">
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 p-4 rounded-xl bg-background border border-border text-sm text-text">
            ...
            <p className="mt-2">
              Se precisar de ajuda antes de entrar, fale com a equipe pelo
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              ...
              <a
                href="mailto:finixappp@gmail.com"
                className="btn-outline text-brand-blue"
              >
                E-mail
              </a>
