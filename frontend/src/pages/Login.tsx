    ...
    <div className="min-h-screen grid lg:grid-cols-2">
        ...
        >
          ...
          <div className="mt-10 grid grid-cols-2 gap-4">
            {[
              ...
              <div key={k.label} className="rounded-2xl bg-surface/10 border border-white/15 backdrop-blur p-4">
      ...
      <div className="flex items-center justify-center p-6 sm:p-12 bg-surface">
        <div className="w-full max-w-md">
          ...
          <p className="text-muted mt-1">Acesse sua conta Finix</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-4" data-testid="login-form">
            ...
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <input
                  ...
                  placeholder="••••••••"
                />
                <button type="button" onClick={() => setShow(!show)} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted hover:text-text" data-testid="toggle-password">
            ...
            >
              <span className="inline-flex h-4 w-4 items-center justify-center rounded-sm bg-surface text-[10px] font-bold text-text">G</span>
              Entrar com Google
            </a>
          </form>

          <div className="mt-6 p-4 rounded-xl bg-background border border-border text-sm text-text">
            <div className="font-semibold text-text">Suporte Finix</div>
